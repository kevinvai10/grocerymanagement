  ...
  render() {
    ...
    return (
      <tr className='separator-line'>
        ...
        <td>
          {this.state.isEdit ? (
            <button className='product-button' onClick={this.handleEdit}>
              Save
            </button>
          ) : (
            <>
              <button
                ...
                onClick={this.handleIncrementCartItem}
              >
                +
              </button>
              <button
                className='product-button'
                onClick={this.handleDecrementCartItem}
              >
                -
              </button>
              <button
              ...
              <button className='product-button' onClick={this.handleDelete}>
                x
              </button>
            </>
          )}
