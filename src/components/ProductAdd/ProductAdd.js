                    ...
                    <form className="measure" onSubmit={this.handleSubmit}>
                        <fieldset id="sign_in" className="ba b--transparent ph0 mh0">
                            ...
                            <div className="mt3">
                                ...
                                <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" value={this.state.product_name} onChange={this.handleNameChange} type="text" name="" id="" />
                            </div>
                            <div className="mv3">
                                <label className="db fw6 lh-copy f6" htmlFor="">Price of the product</label>
                                <input className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" value={this.state.product_price} onChange={this.handlePriceChange} type="text" name="" id="password" />
                            </div>
                            <div className="mv3">
                                <label className="db fw6 lh-copy f6" htmlFor="">Store</label>
                                <input className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" value={this.state.product_store} onChange={this.handleStoreChange} type="text" name="" id="password" />
                            </div>
                            <div className="mv3">
                                <label className="db fw6 lh-copy f6" htmlFor="">Category(optional)</label>
                                <input className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" value={this.state.product_category} onChange={this.handleCategoryChange} type="text" name="" id="password" />
                            </div>
                        </fieldset>
                        <div>
                            <input  
